<div class="container">
    ...
    ?>
    <h1 style="margin-top: 20px;margin-bottom: 20px;" class="tituloListar">Aluguel(éis)</h1>
    <table class="table table-hover table-bordered border-dark">
        <thead class="table-dark">
        <tr>
            <th scope="col" style="width: 5%;">#</th>
            <th scope="col" style="width: 45%;">Locatário</th>
            <th scope="col" style="width: 43%;">Código do empréstimo</th>
            <th scope="col" style="width: 7%;">Ações</th>
        </tr>
        </thead>
        <tbody>
        <?php
