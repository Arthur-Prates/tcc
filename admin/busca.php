...
<div class="container">
    <div class="mt-5 d-flex justify-content-between align-items-center">
        ...
        <form action="busca.php" method="post" name="buscaUsuario" id="buscaUsuario" class="buscaUsuario">
    ...
    <div class="overflowTable" id="tabelaUser">
        <table class="table table-hover table-bordered border-dark  rounded-table">
            ...
            foreach ($resultadoPesquisa as $itemBusca){
                $idusuario = $itemBusca->idusuario;
                $nome = $itemBusca->nomeUsuario;
                $sobrenome = $itemBusca->sobrenome;
                $telefone = $itemBusca->numero;
                $nascimento = $itemBusca->nascimento;
                $cpf = $itemBusca->cpf;
                $cargo = $itemBusca->cargo;
                $email = $itemBusca->email;
                if ($telefone == '') {
